...
class ActiveItemALLExpenses extends StatelessWidget {
  const ActiveItemALLExpenses({
    super.key,
...
class InActiveItemALLExpenses extends StatelessWidget {
  const InActiveItemALLExpenses({
    super.key,
    required this.allmodel,
  });
